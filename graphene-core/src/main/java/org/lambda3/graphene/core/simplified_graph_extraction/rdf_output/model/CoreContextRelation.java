/*
 * ==========================License-Start=============================
 * graphene-core : CoreContextRelation
 *
 ...
 *
 */
public class CoreContextRelation {
	private final String sourceCoreID;
	private final String targetContextID;
	private final Relation relation;

	public CoreContextRelation(String sourceCoreID, String targetContextID, Relation relation) {
	...
	public String toString() {
		return "RHET_REL:" + "\t\t" + sourceCoreID + "\t\t" + relation + "\t\t" + targetContextID;
	}
}
