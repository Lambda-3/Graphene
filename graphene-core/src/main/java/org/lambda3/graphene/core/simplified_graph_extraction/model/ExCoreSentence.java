 ...
 *
 */
public class ExCoreSentence {
	private String id;
	private String text;
	private DiscourseType discourseType;
	private String notSimplifiedText;
	private List<ExContextSentence> contextSentences;
	private List<Extraction> extractions;

	// for deserialization
	public ExCoreSentence() {
	}

	public ExCoreSentence(String text, DiscourseType discourseType, String notSimplifiedText, List<ExContextSentence> contextSentences, List<Extraction> extractions) {
	...
	public List<ExContextSentence> getContextSentences() {
